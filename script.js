...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        'pt': {
            ...
            'project4_title': 'AI Privacy Firewall',
            'project4_desc': 'Firewall em Python que utiliza NLP para sanitizar dados sensíveis e garantir a conformidade com a LGPD em interações com IAs.',
        ...
        'en': {
            ...
            'project4_title': 'AI Privacy Firewall',
            'project4_desc': 'Python-based firewall using NLP to sanitize sensitive data and ensure data privacy compliance for AI interactions.',
